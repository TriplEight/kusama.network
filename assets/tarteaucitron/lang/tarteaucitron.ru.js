...
tarteaucitron.lang = {
    ...
    "adblock_call": "Пожалуйста деактивируйте АдБлокер чтобы начать настройку.",
    "reload": "Перезагрузите страницу",
    
    "alertBigScroll": "Продолжая прокрутку",
    "alertBigClick": "Если вы продолжаете использовать сайт",
    "alertBig": "вы соглашаетесь на сервисы третьих лиц",
    ...
    "all": "Согласиться на все сервисы",

    "info": "Защитить вашу конфиденциальность",
    "disclaimer": "Активирование сервисов третьих лиц разрещает использование их кукис и технолоний отслеживания необходимых для их функционирования",
    "allow": "Позволить",
    "deny": "Не позволить",
    "noCookie": "Этот сервис не использует кукис.",
    "useCookie": "Этот сервис может установить",
    "useCookieCurrent": "Этот сервис установлен",
    "useNoCookie": "Этот сервис не использует кукис.",
    "more": "Подробнее",
    "source": "Посетите официальный сайт",
    "credit": "Кукис менеджер tarteaucitron.js",
